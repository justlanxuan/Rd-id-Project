...
* **实验期:** G_egohumans — **E10/E10b 已完成，SOTA 已归档（formulation / progress / results）**
...
* **当前子任务状态:**
  ...
  - ✅ SOTA 条目已写入 `experiments/G_egohumans/formulation.md` 及 E10/E10b 的 `progress.md` / `results.md`。
  - ⏳ 待完成：将 SOTA 同步写入 `experiments/SOTA_reproduce.md`（需在干净工作区执行）。
...
* [ ] 在干净工作区将 SOTA 写入 `experiments/SOTA_reproduce.md`。
