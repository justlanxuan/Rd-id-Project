#!/usr/bin/env python3
"""
Experiment Note: A4-eval-1imu-subset
Run the 1-IMU (right wrist) model on the 16 MoBInd-train-only sequences for
strict alignment comparison with the 4-IMU model. Supports 1-window and
4-window vote modes.
"""
import argparse
import csv
...
def main():
    ...
    print(f"Saved 1-IMU subset results to {args.output_json}")
